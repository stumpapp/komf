...
class AppContext(private val configPath: Path? = null) {
    ...
    private fun createApiRoutesDependencies() = ApiDynamicDependencies(
        ...
        stumpMediaServerClient = mediaServerModule.stumpMediaServerClient,
        stumpMetadataServiceProvider = mediaServerModule.stumpMetadataServiceProvider,
